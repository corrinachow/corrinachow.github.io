...
const PortfolioEntry = () => (
  <div className="col-4">
    ...
    <div className="small-project-desc">
      <span>Wiki-Maps</span>
      <p>
        Full-stack web app that allows users to create themed maps made using
        the{' '}
        <span className="project-subheader">
          Google Maps API, Google Geocode API, PostgreSQL, Knex, Node.JS,
          Express, jQuery, &amp; Bootstrap 4
        </span>.
      </p>
      <a href="https://github.com/corrinachow/wiki-maps" className="lg-hide">
